      ...
      <section className="w-full flex items-center justify-center relative pt-12">
        <div className="max-w-[1100px] w-full rounded-md shadow-lg/30 shadow-stone-400 p-12">
          <form className="w-full flex items-center justify-center">
            ...
            <button
              type="submit"
              className="bg-primary px-5 py-2 font-medium text-lg border-2 border-primary/70 text-neutral-100 rounded-e-md cursor-pointer ease duration-300 hover:bg-primary flex items-center justify-center gap-2"
            >
              <IoMdSearch />
            </button>
          </form>
            ...
            <>
              {data && data?.files ? (
                <>
                  ...
                  <ul className="max-w-100 w-full list-disc">
                    {data?.files?.map((file: IProps, index: number) => (
                      ...
                      <li key={index}>
                        <Link
                          href={file.url}
                          className="underline font-regural text-md text-blue-600"
                        >
                          {file.title}.pdf
                        </Link>
                      </li>
